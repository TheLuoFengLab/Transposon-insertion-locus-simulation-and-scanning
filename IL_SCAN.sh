...
usage() {
    ...
    echo "  -r, --ref     Reference genome default as ${DIR}/REF/DVS.fasta. Usually no need to modify."
    echo "  -u, --unmask  Unmasked reference genome default as ${DIR}/REF/DVS.masked.34TE.fasta. Usually no need to modify."
